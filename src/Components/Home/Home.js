        ...
        <Container className="homeContainer" id="Home" fluid>
            ...
            <Row>
                <Col className="contactButtons">
                    ...
                    <Button className="homeButton" size="lg" style={{ backgroundColor: "#D5DBDB", border: "none", borderRadius: "50px" }} href="mailto:zacharyfisher808@gmail.com" target="_blank"><FontAwesomeIcon icon={faEnvelopeOpen} className="buttonIcon" style={{ color: "#34495E", fontSize: "3rem", margin: "0 1rem 0 1rem" }} /></Button>
                </Col>
            </Row>
            <Row>
                <Col id="secondRowButtons">
                    <Button href="#Projects" className="secondRowButtons homeButton">Some of my projects!</Button>
                    <Button href={resume} className="secondRowButtons homeButton" download>Download my resume</Button>
                </Col>
            </Row>
        </Container>
    )
